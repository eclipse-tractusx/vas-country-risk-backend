...
import org.eclipse.tractusx.valueaddedservice.dto.bpdm.pool.PoolExtendedPhysicalPostalAddressDto;

import java.io.IOException;

public class ExtendedPhysicalPostalAddressDtoDeserializer extends JsonDeserializer<PoolExtendedPhysicalPostalAddressDto> {

    @Override
    public PoolExtendedPhysicalPostalAddressDto deserialize(JsonParser jp, DeserializationContext ctxt)
            throws IOException {
        ObjectMapper mapper = (ObjectMapper) jp.getCodec();
        JsonNode rootNode = mapper.readTree(jp);

        PoolExtendedPhysicalPostalAddressDto address = new PoolExtendedPhysicalPostalAddressDto();
