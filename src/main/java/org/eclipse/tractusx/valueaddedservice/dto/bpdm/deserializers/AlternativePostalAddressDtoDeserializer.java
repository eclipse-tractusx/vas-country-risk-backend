...
import org.eclipse.tractusx.valueaddedservice.dto.bpdm.AlternativePostalAddressDto;
...
public class AlternativePostalAddressDtoDeserializer extends JsonDeserializer<AlternativePostalAddressDto> {

    @Override
    public AlternativePostalAddressDto deserialize(JsonParser jp, DeserializationContext ctxt)
            throws IOException {
        ObjectMapper mapper = (ObjectMapper) jp.getCodec();
        JsonNode rootNode = mapper.readTree(jp);

        AlternativePostalAddressDto address = new AlternativePostalAddressDto();
